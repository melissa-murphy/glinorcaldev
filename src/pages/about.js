        ...
        <Row>
          <Col className="about-text py-3">
            <Card border="success">
              <Card.Body>
                <Card.Title>
                  GLI NorCal has built outstanding landscapes across the Bay
                  Area for more than 30 years...
                </Card.Title>
                <Card.Text>
                  We specialize in residential and commercial landscape
                  construction projects of all sizes. GLI NorCal’s experience
                  and commitment to excellence is the foundation of our fine
